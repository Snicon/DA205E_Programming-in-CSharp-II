...
namespace DA205E_Assignment3.Animals.Reptile
{
    ...
    public class ReptileFactory
    {
        ...
        /// <summary>
        /// Attempts to create a reptile of the specified species with the provided data from the dictionary. If the spcies couldn't be found in the factory switch statment, null is returned.
        /// </summary>
        /// <param name="species">The species of reptile to create as ReptileSpecies.</param>
