namespace DA205E_Assignment1
{
    partial class AboutBox
    {
        ...
        private void InitializeComponent()
        {
            ...
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 7.166124F));
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 2.605863F));
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 7.166124F));
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 62.86645F));
            tableLayoutPanel.RowStyles.Add(new RowStyle(SizeType.Percent, 10F));
            ...
            textBoxDescription.Location = new Point(167, 85);
            textBoxDescription.Margin = new Padding(7, 3, 4, 3);
            textBoxDescription.Multiline = true;
            textBoxDescription.Name = "textBoxDescription";
            textBoxDescription.ReadOnly = true;
            textBoxDescription.ScrollBars = ScrollBars.Both;
            textBoxDescription.Size = new Size(316, 187);
            ...
            okButton.Location = new Point(395, 278);
