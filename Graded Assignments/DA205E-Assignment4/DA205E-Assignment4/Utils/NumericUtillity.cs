...
namespace DA205E_Assignment4.Utils
{
    /// <summary>
    /// Utility for reading numeric input from text fields or other controls. The logic is mostly based on the help Faird has provided in the LMS but written on my own. (Copied from Assignment 3)
    /// </summary>
    public static class NumericUtility
    {
        ...
        /// </summary>
        /// <param airplaneName="value">The string to convert</param>
