...
namespace DA205E_Assignment4.EventArgsClasses
{
    ...
    /// </summary>
    public class LandedEventArgs : AirplaneEventArgs
    {
        #region Constructor
        /// <summary>
        ...
        public LandedEventArgs(string name, string destination) : base(name, destination) { }
        #endregion
        ...
        {
            get { return $"{Name} has landed in {Destination}, {Timestamp:HH:mm:ss}"; }
        }
        #endregion
    }
}
